...
if st.session_state['username'] == '':
    ...
    start_time = st.selectbox("시작 시간을 선택하세요:", generate_time_range(end='23:59', freq='10T'), index=36)
    end_time = st.selectbox("끝나는 시간을 선택하세요:", generate_time_range(end='23:59', freq='10T'), index=132)
